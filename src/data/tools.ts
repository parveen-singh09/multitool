...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    description:
      'Free online word counter. Instantly count words, characters, sentences, paragraphs and estimated reading time.',
    category: 'Text',
    keywords: [
      'word counter',
      'character counter',
  ...
  },
  {
    ...
    description:
      'Free online JSON formatter and validator. Beautify, minify and validate JSON with clear error messages.',
    category: 'Developer',
    keywords: [
      'json formatter',
      'json beautifier',
  ...
  },
  {
    ...
    description:
      'Free online Base64 encoder and decoder. Convert text to Base64 and decode Base64 back to text instantly. Works offline.',
    category: 'Developer',
    keywords: [
      'base64 encode',
      'base64 decode',
  ...
  },
  {
    ...
    description:
      'Free online URL encoder and decoder. Percent-encode query strings and decode URL-encoded text instantly.',
    category: 'Developer',
    keywords: [
      'url encoder',
      'url decoder',
  ...
  },
  {
    ...
    description:
      'Free online hash generator. Create SHA-1, SHA-256, SHA-384 and SHA-512 hashes from any text using the Web Crypto API.',
    category: 'Security',
    keywords: [
      'hash generator',
      'sha256 generator',
  ...
  },
  {
    ...
    description:
      'Free online QR code generator. Encode a URL, WiFi login, vCard, email, SMS, location, event or Bitcoin address, then customize the dot and eye shapes, colors, gradients and center logo. Download high-resolution PNG or vector SVG.',
    category: 'Generators',
    keywords: [
      'qr code generator',
...

  {
    ...
    description:
      'Free online text diff checker. Compare two blocks of text line by line and highlight added and removed lines instantly.',
    category: 'Text',
    keywords: [
      'text diff',
      'diff checker',
  ...
  },
  {
    ...
    description:
      'Free online slug generator. Convert titles and text into clean, SEO-friendly URL slugs with hyphens and lowercase instantly.',
    category: 'Text',
    keywords: [
      'slug generator',
      'url slug generator',
...

  {
    ...
    description:
      'Free online regex tester. Test JavaScript regular expressions against text with live match highlighting, flags and capture groups.',
    category: 'Developer',
    keywords: [
      'regex tester',
  ...
  },
  {
    ...
    description:
      'Free online JWT decoder. Decode a JSON Web Token to inspect its header and payload claims instantly.',
    category: 'Developer',
    keywords: [
      'jwt decoder',
      'decode jwt',
  ...
  },
  {
    ...
    description:
      'Free online Unix timestamp converter. Convert epoch timestamps (seconds, milliseconds, microseconds or nanoseconds) to human-readable dates in any timezone — with ISO 8601, RFC 2822, GMT, relative time and a custom format.',
    category: 'Developer',
    keywords: [
  ...
  },
  {
    ...
    description:
      'Free online number base converter. Convert numbers between binary, octal, decimal and hexadecimal instantly. Fast and accurate.',
    category: 'Developer',
    keywords: [
  ...
  },
  {
    ...
    description:
      'Free online Markdown previewer. Write Markdown and see the rendered HTML update live side by side. Great for READMEs and notes.',
    category: 'Developer',
    keywords: [
      'markdown previewer',
  ...
  },
  {
    ...
    description:
      'Free online HTML entity encoder and decoder. Convert special characters to HTML entities and back to escape markup safely.',
    category: 'Developer',
    keywords: [
      'html entity encoder',
      'html entity decoder',
...

  {
    ...
    description:
      'Free online image resizer. Resize JPG, PNG and WebP images by dimensions or percentage and download instantly.',
    category: 'Image',
    keywords: [
      'image resizer',
      'resize image online',
  ...
  },
  {
    ...
    description:
      'Free online image to Base64 converter. Turn JPG, PNG, GIF and SVG images into Base64 data URI strings for CSS or HTML.',
    category: 'Image',
    keywords: [
      'image to base64',
  ...
  },
  {
    ...
    description:
      'Free online image color picker. Upload an image and pick any pixel to get its HEX and RGB color values.',
    category: 'Image',
    keywords: [
      'image color picker',
...

  {
    ...
    description:
      'Free online UUID / GUID generator. Create RFC 4122 & 9562 UUIDs — v4 random, v7 time-ordered, v1/v6 time-based, v3/v5 namespace, plus nil & max — one at a time or up to 10,000 at once.',
    category: 'Generators',
    keywords: [
      'uuid generator',
      'guid generator',
  ...
  },
  {
    ...
    description:
      'Free online random number generator. Generate random integers between any min and max, in bulk, with optional unique and sorted output.',
    category: 'Generators',
    keywords: [
...

  {
    ...
    description:
      'Free online unit converter. Convert between metric and imperial units of length, weight and temperature instantly. Fast and accurate.',
    category: 'Converters',
    keywords: [
      'unit converter',
      'metric to imperial',
...

  {
    ...
    description:
      'Free online percentage calculator. Find what X% of Y is, what percent one number is of another, and percentage increase or decrease. Instant.',
...

  {
    ...
    description:
      'Free online loan calculator. Calculate your monthly EMI, total interest and total repayment for any loan amount, interest rate and term. Instant.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free online mortgage calculator. Estimate monthly principal and interest payments, with optional property tax and insurance, for any home loan.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free online compound interest calculator. See how your money grows over time with adjustable rate, compounding frequency and regular contributions. Instant.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free online investment calculator. Project the future value of a lump sum plus regular contributions at a given return rate over time.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free online savings goal calculator. Work out how much to save each month to reach a target amount by a set date, including interest. Instant.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free online tip calculator. Calculate the tip and total for any bill, split it between any number of people, and see the per-person amount. Fast.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free online discount calculator. Enter a price and percentage off to get the amount saved and the final sale price. Add a second discount too.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free online sales tax calculator. Add sales tax, VAT or GST to a price, or work backwards to find the pre-tax amount and tax portion. Instant.',
    category: 'Calculators',
...

  {
    ...
    description:
      'Free online BMI calculator. Calculate your Body Mass Index from height and weight in metric or imperial units, and see your weight category. Instant.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free online BMR calculator. Estimate your basal metabolic rate — the calories your body burns at rest — using the Mifflin-St Jeor equation.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free online calorie calculator. Estimate your daily calorie needs (TDEE) from BMR and activity level for maintenance, weight loss or gain. Instant.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free online body fat calculator. Estimate your body fat percentage using the US Navy tape method from a few body measurements.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free online ideal weight calculator. Estimate your ideal body weight from height and sex using the Devine, Robinson and Hamwi formulas. Instant.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free online pace calculator. Calculate running pace, finish time or distance for runs — enter any two values to find the third. Great for race training.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free online water intake calculator. Estimate how much water you should drink each day based on your body weight and activity level.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free online pregnancy due date calculator. Estimate your baby’s due date and current week from your last menstrual period using Naegele’s rule. Instant.',
    category: 'Calculators',
...

  {
    ...
    description:
      'Free online scientific calculator. Evaluate math expressions with parentheses, powers, roots and trig, log and ln functions.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free online fraction calculator. Add, subtract, multiply and divide fractions and get the result simplified to lowest terms. Instant.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free online average calculator. Enter a list of numbers to instantly get the mean, median, mode, range, sum and count.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free online standard deviation calculator. Get population and sample standard deviation, variance, mean and count from a list of numbers. Instant.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free online ratio calculator. Simplify a ratio to its lowest terms or solve equivalent ratios for a missing value (A:B = C:X).',
    category: 'Calculators',
...

  {
    ...
    description:
      'Free online date difference calculator. Count the exact days, weeks, months and years between two dates, or add and subtract days from a date. Instant.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free online time calculator. Add or subtract times and durations in hours, minutes and seconds and see the total.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free online hours calculator. Calculate hours and minutes worked between a start and end time, minus breaks — a quick timesheet tool.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free online GPA calculator. Add your courses with grades and credit hours to calculate a weighted grade point average on a 4.0 scale.',
    category: 'Calculators',
...

  {
    ...
    description:
      'Free Army Fitness Test (AFT) calculator. Score all six events — deadlift, power throw, push-ups, sprint-drag-carry, plank and the 2-mile run — out of 600 against the official age and sex standards, with the full scoring chart shown for verification.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free USMC PFT calculator. Score pull-ups or push-ups, plank hold and the 3-mile run against Marine Corps age and sex standards for a total out of 300.',
    category: 'Calculators',
...

  {
    ...
    description:
      'Free AP English Language & Composition score calculator. Enter multiple-choice and essay scores to estimate your 1–5 AP Lang score from the composite.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free APUSH score calculator. Enter your multiple-choice, short-answer, DBQ and long-essay scores to estimate your 1–5 AP US History score.',
    category: 'Calculators',
...

  {
    ...
    description:
      'Free biological age calculator. Estimate your body’s age from lifestyle factors like exercise, sleep, diet, smoking and stress compared to your actual age.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free creatinine clearance calculator. Estimate renal function (CrCl) with the Cockcroft-Gault equation from age, weight, sex and serum creatinine.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free peptide reconstitution calculator. Work out how much bacteriostatic water to add and the syringe units to draw for a target peptide dose.',
    category: 'Calculators',
...

  {
    ...
    description:
      'Free Texas paycheck calculator. Estimate your take-home pay after federal income tax, Social Security and Medicare — Texas has no state income tax.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free gold value calculator. Work out the melt value of gold by weight and karat from the current spot price, for scrap, jewelry or coins.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free silver value calculator. Work out the melt value of silver by weight and fineness from the live spot price, for scrap, sterling, coins or bullion.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free platinum value calculator. Work out the melt value of platinum by weight and fineness from the live spot price, for scrap, jewelry or bullion.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free dynasty fantasy football trade calculator. Add players and picks to each side and compare total trade value to see who wins the deal.',
    category: 'Calculators',
...

  {
    ...
    description:
      'Free online retirement calculator. Project your 401(k) or retirement savings balance from current age, contributions, employer match and expected return.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free online auto loan calculator. Estimate your monthly car payment from price, down payment, trade-in, sales tax, term and APR, plus total interest.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free online credit card payoff calculator. See how many months it takes to clear a balance at a fixed monthly payment and APR, and the total interest paid.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free online debt payoff calculator. Compare the snowball and avalanche methods across multiple debts, with extra payments, to find months to debt-free and total interest.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free online inflation calculator. See what an amount will cost in future years and how much today’s money will be worth in real terms at a given inflation rate.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free online salary calculator. Convert a pay rate between hourly, daily, weekly, bi-weekly, monthly and annual figures using your hours and weeks worked.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free online profit margin calculator. Enter cost and sale price to get profit, gross margin percentage and markup, or find the price needed for a target margin.',
    category: 'Calculators',
...

  {
    ...
    description:
      'Free online macro calculator. Get your daily calorie target and protein, carb and fat grams from your stats, activity level and goal using the Mifflin-St Jeor equation.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free online one rep max calculator. Estimate your 1RM from weight and reps with the Epley and Brzycki formulas, plus a full table of training percentages.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free online sleep calculator. Find the best times to go to bed or wake up based on 90-minute sleep cycles so you wake between cycles feeling refreshed.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free online BAC calculator. Estimate blood alcohol content from drinks, body weight, sex and time using the Widmark formula. An estimate only — never a guide to drive.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free online heart rate zone calculator. Find your maximum heart rate and five target training zones in beats per minute, with optional Karvonen resting-rate method.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free online ovulation calculator. Estimate your most fertile days, ovulation date and next period from your last period and average cycle length. An estimate, not contraception.',
    category: 'Calculators',
...

  {
    ...
    description:
      'Free online quadratic equation calculator. Solve ax²+bx+c=0 for real or complex roots, with the discriminant and vertex shown. Handles linear cases too.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free online probability calculator. Find the probability of two independent events happening together, either one, neither or just one, from P(A) and P(B).',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free online permutation and combination calculator. Compute nPr and nCr from n and r, with factorials shown and big-number handling. Fast.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free online right triangle calculator. Enter any two sides to solve the third with the Pythagorean theorem, plus area, perimeter and both acute angles.',
    category: 'Calculators',
...

  {
    ...
    description:
      'Free online grade calculator. Turn correct answers into a percentage and letter grade, and work out your weighted overall grade from assignments and their weights.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free online final grade calculator. Work out the score you need on your final exam to reach a target course grade, from your current grade and the exam’s weight.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free online fuel cost calculator. Estimate the fuel needed and total cost of a trip from distance, fuel efficiency and price, in metric or US units.',
    category: 'Calculators',
...

  {
    ...
    description:
      'Free gematria calculator. Convert words and phrases to their numeric value using English Ordinal, Full Reduction, Hebrew, Simple and Jewish gematria ciphers.',
    category: 'Text',
...

  {
    ...
    description:
      'Free online HEX to RGB converter. Turn any hex color code into red, green and blue values for CSS, plus HSL, HSV, CMYK and the nearest color name.',
    category: 'Converters',
  ...
  },
  {
    ...
    description:
      'Free online RGB to HEX converter. Turn red, green and blue values into a hex color code for CSS and design tools, plus HSL, HSV and CMYK.',
    category: 'Converters',
  ...
  },
  {
    ...
    description:
      'Free online RGB to HSL and HSV converter. Convert red, green and blue into hue, saturation, lightness (HSL) and value (HSB), plus HEX and CMYK.',
    category: 'Converters',
  ...
  },
  {
    ...
    description:
      'Free online CMYK converter. Convert colors between the CMYK print model and HEX, RGB, HSL and HSV screen models with accurate math.',
    category: 'Converters',
  ...
  },
  {
    ...
    description:
      'Free online CSS gradient generator. Build linear, radial and conic gradients with multiple color stops, adjustable angle and positions, and copy the CSS.',
    category: 'Generators',
...

  {
    ...
    description:
      'Free online binary converter. Convert decimal numbers to binary and back, and translate text to 8-bit binary ASCII codes, with hex and octal shown too.',
    category: 'Converters',
  ...
  },
  {
    ...
    description:
      'Free online hexadecimal converter. Convert decimal numbers to hex and back, and translate text to its UTF-8 hex byte codes, with binary and octal shown too.',
    category: 'Converters',
  ...
  },
  {
    ...
    description:
      'Free online Roman numeral converter. Convert numbers to Roman numerals and Roman numerals back to numbers, with subtractive notation and large-value overlines.',
    category: 'Converters',
  ...
  },
  {
    ...
    description:
      'Free online number to words converter. Spell out any number in English for cheques, contracts and invoices, with decimals, negatives and a dollars-and-cents currency mode.',
    category: 'Converters',
  ...
  },
  {
    ...
    description:
      'Free online fraction to decimal converter. Convert fractions and mixed numbers to decimals and percentages, and turn decimals — including repeating ones — into simplified fractions.',
    category: 'Converters',
  ...
  },
  {
    ...
    description:
      'Free online scientific notation converter. Convert decimal numbers to scientific notation and back, with E-notation, engineering notation and order of magnitude shown.',
    category: 'Converters',
...

  {
    ...
    description:
      'Free online JSON converter. Transform JSON into XML, YAML or CSV with nested-structure support and copy the result. Fast.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free online Morse code translator. Convert text to Morse code and back, covering letters, numbers and punctuation, and play your message as audio beeps.',
    category: 'Text',
  ...
  },
  {
    ...
    description:
      'Free online Unicode and emoji converter. Reveal the code points behind any text or emoji and encode them as HTML entities, JavaScript escapes and U+ notation.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free online ASCII art generator. Turn text into large ASCII letter banners for code comments, terminals and READMEs, in several styles, and copy the result.',
    category: 'Text',
  ...
  },
  {
    ...
    description:
      'Free online barcode generator supporting 30+ symbologies — Code 128, Code 39, EAN/UPC, GS1, QR Code, Data Matrix, PDF417, Aztec, MaxiCode and postal codes. Adjust size, colors, rotation and label, then download as PNG or SVG.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online text to speech tool. Read any text aloud using the voices built into your device, with adjustable rate and pitch.',
    category: 'Text',
...

  {
    ...
    description:
      'Free online time zone converter. Convert a date and time across multiple world cities and zones at once, with daylight saving handled automatically.',
    category: 'Converters',
  ...
  },
  {
    ...
    description:
      'Free online date format converter. Parse a date in almost any format or as a Unix timestamp and see it in ISO 8601, RFC 2822, US, European and long forms at once.',
    category: 'Converters',
...

  {
    ...
    description:
      'Free online PX to REM converter. Convert pixel values to rem and em units for responsive CSS with a custom root font size, and back again, with a reference table.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free online SQL formatter. Beautify messy SQL into clean, readable queries with clause-per-line layout, indentation and configurable keyword case.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free online cURL to code converter. Turn a curl command into JavaScript fetch, Node.js axios or Python requests code, including method, headers and body.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free online JSON to TypeScript converter. Turn a JSON sample into clean TypeScript interfaces, inferring types for nested objects and arrays. Fast.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free online JavaScript beautifier and minifier. Beautify messy code with clean indentation, or minify it to shrink file size, preserving strings and comments.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free online GPS coordinate converter. Convert latitude and longitude between decimal degrees, DMS, DDM and UTM, and build a geo URI. Great for maps and navigation.',
    category: 'Converters',
  ...
  },
  {
    ...
    description:
      'Free online IP address converter. Convert an IPv4 address between dotted-decimal, 32-bit integer, hexadecimal, binary and IPv4-mapped IPv6 forms.',
    category: 'Converters',
  ...
  },
  {
    ...
    description:
      'Free online text encoding converter. See the raw bytes behind text in UTF-8, UTF-16 and ASCII in hex, decimal or binary, and decode UTF-8 bytes back to text.',
    category: 'Developer',
...

  {
    ...
    description:
      'Free online shoe and clothing size converter. Convert between US, UK and EU shoe sizes with foot length in cm, plus clothing sizes, using full charts.',
    category: 'Converters',
  ...
  },
  {
    ...
    description:
      'Free online bra size converter. Convert band and cup sizes between US, UK, European and French systems, handling the differing band numbers and cup letters.',
    category: 'Converters',
  ...
  },
  {
    ...
    description:
      'Free online aspect ratio calculator. Find the simplified ratio of any screen or image size and resize dimensions while keeping the ratio, with common presets.',
    category: 'Converters',
...

  {
    ...
    description:
      'Free online JPG to PNG converter. Turn JPEG photos into lossless PNG images with no quality loss. Fast and free.',
    category: 'Image',
  ...
  },
  {
    ...
    description:
      'Free online PNG to WebP converter. Convert PNG images to smaller WebP files with adjustable quality, keeping transparency.',
    category: 'Image',
  ...
  },
  {
    ...
    description:
      'Free online WebP to JPG converter. Turn WebP images into widely compatible JPEG files with adjustable quality, flattening transparency to white.',
    category: 'Image',
  ...
  },
  {
    ...
    description:
      'Free online PNG to JPG converter. Turn PNG images into smaller, widely compatible JPEG files with adjustable quality, flattening transparency to white.',
    category: 'Image',
  ...
  },
  {
    ...
    description:
      'Free online JPG to WebP converter. Convert JPEG photos to smaller WebP files with adjustable quality for faster web pages.',
    category: 'Image',
  ...
  },
  {
    ...
    description:
      'Free online WebP to PNG converter. Turn WebP images into lossless PNG files, preserving transparency for editing or platforms that do not accept WebP.',
    category: 'Image',
  ...
  },
  {
    ...
    description:
      'Free online SVG to PNG converter. Rasterize scalable vector graphics into PNG images with transparency, for platforms that do not accept SVG.',
    category: 'Image',
  ...
  },
  {
    ...
    description:
      'Free online BMP converter. Convert JPG, PNG and WebP images into uncompressed 24-bit Windows Bitmap (.bmp) files.',
    category: 'Image',
  ...
  },
  {
    ...
    description:
      'Free online ICO converter. Turn any image into a multi-resolution Windows icon or favicon (.ico) at 16, 32, 48 and 64 pixels using embedded PNG data.',
    category: 'Image',
  ...
  },
  {
    ...
    description:
      'Free online Base64 to image converter. Decode a Base64 string or data URI back into a viewable image and download it. The counterpart to image-to-Base64.',
    category: 'Image',
...

  {
    ...
    description:
      'Free online speech to text tool. Transcribe your voice into editable text live using your browser’s built-in speech recognition, in many languages.',
    category: 'Text',
...

  {
    ...
    description:
      'Free online image to PDF converter. Combine JPG and PNG images into a single PDF, reorder pages, and choose page size and margins.',
    category: 'PDF',
  ...
  },
  {
    ...
    description:
      'Free online PDF merge tool. Combine several PDF files into a single document and reorder them by dragging, preserving page content and sizes.',
    category: 'PDF',
  ...
  },
  {
    ...
    description:
      'Free online PDF split tool. Extract a page range into a new PDF or split every page into its own file. The original is untouched.',
    category: 'PDF',
  ...
  },
  {
    ...
    description:
      'Free online PDF to JPG converter. Render each page of a PDF into a JPG or PNG image at your chosen resolution, then download single pages or all of them.',
    category: 'PDF',
  ...
  },
  {
    ...
    description:
      'Free online PDF to Word converter. Pull the text out of a PDF into an editable Word (.docx) document. Preserves text and paragraphs; layout is not reproduced.',
    category: 'PDF',
  ...
  },
  {
    ...
    description:
      'Free online PDF to Excel converter. Detect row-and-column data in a PDF and export it to an editable Excel (.xlsx) spreadsheet. Best for tabular data; complex layouts may need cleanup.',
    category: 'PDF',
  ...
  },
  {
    ...
    description:
      'Free online HTML to PDF converter. Paste HTML or a full page, preview the rendered result, and save it as a text-selectable PDF using your browser’s own print engine.',
    category: 'PDF',
  ...
  },
  {
    ...
    description:
      'Free online PDF summarizer. Extract a PDF’s text and get an AI summary — short, paragraph or bullet points. Only the extracted text is sent for summarizing.',
    category: 'PDF',
...

  {
    ...
    description:
      'Free online HEIC to JPG converter. Convert Apple HEIC and HEIF photos into universal JPG or PNG images, in bulk, with adjustable quality.',
    category: 'Image',
  ...
  },
  {
    ...
    description:
      'Free online TIFF converter. Convert TIFF/TIF images to PNG, JPG or WebP, or turn ordinary images into TIFF. Decoded with a pure-JS engine.',
    category: 'Image',
  ...
  },
  {
    ...
    description:
      'Free online PNG to SVG converter. Vectorize logos, icons and flat graphics into scalable SVG paths with adjustable detail, then download.',
    category: 'Image',
...

  {
    ...
    description:
      'Free online video to GIF converter. Turn a clip from any video into an animated GIF with adjustable start, duration, width and frame rate, using a clean two-pass palette.',
    category: 'Audio & Video',
  ...
  },
  {
    ...
    description:
      'Free online GIF to MP4 converter. Turn animated GIFs into MP4 video that is a fraction of the size for the same animation, ideal for web and messaging.',
    category: 'Audio & Video',
  ...
  },
  {
    ...
    description:
      'Free online audio compressor. Reduce MP3, WAV and M4A file size by re-encoding to MP3 at a chosen bitrate, with an optional mono mixdown for voice.',
    category: 'Audio & Video',
  ...
  },
  {
    ...
    description:
      'Free online audio speed and pitch changer. Slow down or speed up audio and shift pitch in semitones, independently or linked, for practice, transcription and effects.',
    category: 'Audio & Video',
  ...
  },
  {
    ...
    description:
      'Free online music analyzer. Detect the tempo (BPM), musical key and Camelot code, genre and mood, energy and danceability, plus LUFS loudness and the HPCP chroma of any song. Analyze a file or microphone.',
    category: 'Audio & Video',
...

  {
    ...
    description:
      'Free online UPC code generator. Create valid UPC-A retail barcodes with a correct mod-10 check digit and download them as PNG or SVG.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online ISBN generator. Create valid ISBN-13 book numbers with a correct check digit and matching EAN-13 barcode you can download as PNG or SVG.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online GTIN generator. Create valid GTIN-8, GTIN-12, GTIN-13 and GTIN-14 global trade item numbers with a correct check digit and barcode.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online IMEI number generator. Create 15-digit IMEI numbers that pass the Luhn checksum, for app testing and QA. For testing only — these are not real devices.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online Data Matrix generator. Encode any text or numbers into a compact Data Matrix 2D barcode and download it as PNG or SVG.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online PDF417 barcode generator. Encode text and data into a high-capacity PDF417 stacked 2D barcode — used on IDs and boarding passes — and download it.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online VIN generator. Create 17-character vehicle identification numbers with a valid position-9 check digit, for testing and sample data. Not real vehicles.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online serial number generator. Create sequential or random serial numbers in bulk with a custom prefix, suffix, length and padding.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online SKU generator. Build structured stock-keeping unit codes from a brand, category, color and size, or generate them in bulk.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online voucher code generator. Create readable gift and voucher codes in grouped blocks (e.g. XXXX-XXXX-XXXX) with no ambiguous characters, in bulk.',
    category: 'Generators',
...

  {
    ...
    description:
      'Free online passphrase generator. Create strong, memorable passphrases from random common words in the Diceware style, with adjustable word count, separators and casing.',
    category: 'Security',
  ...
  },
  {
    ...
    description:
      'Free online PIN generator. Create random numeric PINs of any length (4, 6 or custom) one at a time or in bulk, using a secure random source.',
    category: 'Security',
  ...
  },
  {
    ...
    description:
      'Free online API key generator. Create high-entropy API keys with an optional prefix (like sk_live_) in hex, base62 or base64url, one or many at a time.',
    category: 'Security',
  ...
  },
  {
    ...
    description:
      'Free online secret key generator. Generate cryptographically strong secret keys of 128 to 512 bits in hex, base64 or base64url — ideal for JWT, session and app secrets.',
    category: 'Security',
  ...
  },
  {
    ...
    description:
      'Free online random token generator. Generate secure random tokens in hex, base64url, base62 or a custom alphabet, at any length and in bulk, using the Web Crypto API.',
    category: 'Security',
  ...
  },
  {
    ...
    description:
      'Free online TOTP and 2FA code generator. Create a Base32 TOTP secret, see the live 6-digit code refresh every 30 seconds, and get the otpauth URL and QR for authenticator apps.',
    category: 'Security',
  ...
  },
  {
    ...
    description:
      'Free online bcrypt generator. Hash passwords with bcrypt at an adjustable cost factor, and verify a password against an existing bcrypt hash.',
    category: 'Security',
  ...
  },
  {
    ...
    description:
      'Free online .htpasswd generator. Create Apache and Nginx basic-auth credential lines with bcrypt or SHA hashing from a username and password, ready to paste into your .htpasswd file.',
    category: 'Security',
  ...
  },
  {
    ...
    description:
      'Free online SSL CSR generator. Create a certificate signing request (CSR) and matching Ed25519 or RSA private key from your domain and organization details.',
    category: 'Security',
...

  {
    ...
    description:
      'Free online fake name generator. Generate random realistic names across 13 nationality name sets — American, British, Italian, Spanish, French, German, Japanese, Chinese, Indian, Arabic, Russian and more — by gender and display format, one at a time or in bulk.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free temporary email generator with a real disposable inbox — receive verification codes and links with no signup, then throw the address away. Plus bulk random addresses for test data.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online random user profile generator. Generate complete fake user profiles — name, username, email, phone, address, birthday and avatar initials — as JSON for testing.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free company name generator. Turn keywords into brandable business and startup name ideas across styles like brandable, compound and evocative, with logo previews and saved favorites.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online username generator. Generate unique, available-looking usernames and handles from adjectives, nouns and numbers for games, social media and sign-ups.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online test data generator. Define your own columns and data types — names, emails, dates, number ranges, UUIDs, credit cards, pick-from-list and more — set a row count and locale, and export fictional records as JSON, CSV, SQL, XML or YAML. Seedable and reproducible. Not a real ID.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online mock JSON data generator. Generate arrays of realistic fake records — id, name, email, address, dates and more — as JSON for API mocking and testing.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free online CSV test data generator. Generate rows of realistic fake records with the columns you choose and download them as a CSV file for spreadsheets, imports and testing.',
    category: 'Developer',
...

  {
    ...
    description:
      'Free online CSS box-shadow generator. Adjust offset, blur, spread, color and inset with a live preview and copy the exact box-shadow CSS. Layer multiple shadows.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free online CSS border-radius generator. Set each corner independently, create organic blob shapes with 8-point radii, and copy the border-radius CSS. Live preview.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free online glassmorphism generator. Design frosted-glass cards with adjustable blur, transparency, color and border, preview them over a gradient, and copy the CSS including backdrop-filter.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free online CSS animation generator. Pick an effect like fade, slide, bounce, pulse or spin, tune duration, delay, timing and iterations, preview it live, and copy the @keyframes CSS.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free online media query generator. Build responsive CSS media queries for common device breakpoints or custom min/max widths, orientation and dark mode, and copy the rule.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free online Flexbox and CSS Grid generator. Toggle direction, justify, align, wrap and gap (or grid columns and rows), see the layout update live, and copy the container CSS.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free online SVG wave generator. Create smooth wave section dividers with adjustable height, amplitude, randomness and color, and download the SVG or copy the code. Great for hero and footer edges.',
    category: 'Image',
  ...
  },
  {
    ...
    description:
      'Free online blob shape generator. Create smooth, random organic blob shapes as SVG with adjustable complexity, contrast and color, and download or copy the code — great for backgrounds and avatars.',
    category: 'Image',
  ...
  },
  {
    ...
    description:
      'Free online color palette generator. Generate random palettes or build harmonies — complementary, analogous, triadic and more — from a base color, lock favorites and copy HEX values.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online pattern background generator. Create seamless repeating background patterns — dots, grid, stripes, checkers and more — with custom colors and scale, then download the SVG or copy the CSS.',
    category: 'Image',
...

  {
    ...
    description:
      'Free online favicon generator. Create a favicon from a letter, emoji or shape with custom colors, and download PNG sizes (16–512) plus a multi-size ICO.',
    category: 'Image',
  ...
  },
  {
    ...
    description:
      'Free online avatar generator. Create clean initials avatars or unique geometric identicons from a name or seed, with color themes, and download as PNG.',
    category: 'Image',
  ...
  },
  {
    ...
    description:
      'Free online banner generator. Create social media and web banners at preset sizes (Twitter, Facebook, LinkedIn, YouTube) with a gradient or solid background, heading and subtext, and download as PNG.',
    category: 'Image',
  ...
  },
  {
    ...
    description:
      'Free online watermark generator. Add a text or logo watermark to one photo or a whole batch — single or tiled (straight/diagonal), with adjustable opacity, size, rotation, color, drag-to-position and reusable templates. Export to PNG, JPEG or WEBP, or download all as a ZIP.',
    category: 'Image',
  ...
  },
  {
    ...
    description:
      'Free online signature generator. Draw your signature with a mouse or finger, or type it in a handwriting-style font, then download a transparent PNG for documents and emails.',
    category: 'Image',
  ...
  },
  {
    ...
    description:
      'Free online business card generator with 12 designed templates, front & back sides, logo and background upload, custom accent color and fonts, and a scannable vCard QR code. Preview live and download 300-DPI PNGs or a print-ready PDF.',
    category: 'Image',
...

  {
    ...
    description:
      'Free online meta tag generator. Create SEO meta tags — title, description, keywords, author, robots, viewport and charset — plus Open Graph and Twitter cards, ready to paste into your HTML head.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free online Open Graph generator. Build og: and Twitter card meta tags for title, description, image, URL and type so your links show rich previews on Facebook, LinkedIn and X.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free online robots.txt generator. Build a valid robots.txt with per-user-agent allow and disallow rules, crawl delay and a sitemap reference, then copy or download it.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free online sitemap.xml generator. Enter a website URL and it crawls your pages by following internal links, then builds a valid XML sitemap with automatic depth-based priority, change frequency and lastmod. Or paste your own URL list. Copy or download the file.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free online .htaccess generator. Assemble common Apache rules — force HTTPS, force www or non-www, redirects, custom error pages, caching and compression — into a ready-to-use .htaccess file.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free online mailto link generator. Build a mailto: link with recipients, CC, BCC, subject and a pre-filled body, then copy the link or a ready-to-paste HTML anchor.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free online .gitignore generator. Select the languages, frameworks and tools you use — Node, Python, macOS, VS Code and more — to build a combined .gitignore, then copy or download it.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free online cron expression generator. Build a cron schedule from simple dropdowns or presets, see it explained in plain English, and copy the five-field expression for your crontab.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free online regex generator. Paste example text and it auto-recognizes dates, times, IPs, emails, URLs, UUIDs and numbers — click any part to change how it matches. Add named capture groups, test live, and copy ready-to-run code for JavaScript, Python, PHP, Java, Go or C#. No regex syntax required.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free online HTML table generator. Edit cells in a live grid, paste from Excel or Google Sheets, upload a CSV, style header/body colors, striped rows, borders, padding, and a caption, merge cells with colspan/rowspan, and export clean HTML with scoped CSS, Markdown, or CSV.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free online Markdown table generator. Fill in a live grid, choose column alignment, and get a clean, aligned Markdown table you can paste into READMEs, GitHub and docs.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free online schema markup generator. Create JSON-LD structured data for common Schema.org types — Article, Product, LocalBusiness, FAQ, Organization and more — for rich search results.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free online code snippet image generator. Paste code, pick a theme and window style, and export a polished PNG image of your snippet for slides, docs and social — like Carbon.',
    category: 'Developer',
...

  {
    ...
    description:
      'Free hashtag generator for Instagram, TikTok, YouTube, X, Facebook & LinkedIn. Turns keywords into relevant tags grouped by reach tier — broad, popular and niche — with select-and-copy.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online headline generator. Enter a topic and get catchy, click-worthy blog and article headline ideas using proven copywriting formulas — how-tos, listicles and questions.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online brand name generator. Generate inventive brand and startup name ideas from a keyword using blends, prefixes, suffixes and invented words, with a matching tagline hint.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online domain name generator. Turn a keyword into domain name ideas across popular TLDs — .com, .io, .app, .dev and more — with prefixes, suffixes and blends to spark availability.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online slogan generator. Enter your brand or product name to generate catchy taglines and slogans from proven marketing templates, ready to inspire your campaign.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online random word generator. Generate random words — nouns, verbs, adjectives or a mix — one at a time or in bulk, great for brainstorming, games, writing prompts and passwords.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online random sentence generator. Generate grammatically-structured random sentences for writing prompts, typing practice, placeholder copy and creativity exercises.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online story idea generator. Spark your next story with random prompts combining a character, setting, goal and obstacle, plus a genre and opening line. Great for writers beating the blank page.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online poem generator. Generate short poems — including haiku and rhyming couplets — from a theme or word to inspire your writing or add a personal touch to a card.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online acronym generator. Turn a phrase into an acronym, or build a backronym by finding words that fit each letter of a name, for projects, teams and branding.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free stylish name generator. Turn any name into 100+ fancy fonts, cool symbols and nickname styles — bold, italic, cursive, gothic, bubble and upside-down text, plus decorated gaming frames for PUBG, Free Fire, Roblox, Discord, Instagram and TikTok. Tap to copy.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online bio generator. Create short, punchy bios for Instagram, X, LinkedIn and personal sites from your role, interests and a vibe — professional, casual or witty.',
    category: 'Generators',
...

  {
    ...
    description:
      'Free online random string generator. Generate random strings of any length from letters, numbers, symbols or a custom character set, in bulk, using secure randomness.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online dice roller. Roll any number of dice from D4 to D20 (and D100) with a modifier and running total, for board games and tabletop RPGs. Uses secure randomness.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online coin flip. Flip a fair virtual coin for heads or tails, flip several at once, and see running stats — a quick, unbiased way to decide. Uses secure randomness.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online lottery number generator. Generate random number picks for Powerball, Mega Millions, EuroMillions, Lotto 6/49 or a custom game, with a bonus ball. Uses secure randomness.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online random date generator. Generate random dates within a range you set, optionally with times, in bulk, for testing, sampling and games. Uses secure randomness.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online wheel spinner and random name picker. Enter names or options, spin a colorful high-fidelity wheel with tick sounds and confetti, weight entries, remove winners, and go fullscreen. Fair and secure.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online team generator. Paste a list of names and split them randomly into a set number of teams or by team size, with balanced groups — great for sports, class and games.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online random letter generator. Generate random letters from A to Z, uppercase or lowercase, one or many at a time — great for games, drawing prompts and teaching. Uses secure randomness.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online name combiner. Blend two names into portmanteau combinations — for couple ship names, brand mashups, pet names and baby names. Generates several blends to choose from.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online zodiac sign finder. Enter a birth date to get the Western zodiac sign, its element, dates and key traits, plus the Chinese zodiac animal for the year.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online excuse generator. Generate funny, plausible excuses for being late, missing work, skipping the gym or ducking an event — for laughs, not lying.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online compliment and insult generator. Generate warm, uplifting compliments or lighthearted, playful insults (Shakespearean roasts included) for fun and banter. All in good humor.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online trivia question generator. Draw random trivia questions across categories — science, history, geography, pop culture and more — with reveal-on-click answers for quizzes and game night.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free random recipe generator. Get random meal ideas — a dish name, key ingredients and a simple method sketch — by cuisine and meal type, to break out of a cooking rut.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online workout generator. Generate a random workout routine by focus — full body, upper, lower, core or cardio — with exercises, sets and reps scaled to your level. No equipment options included.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online emoji generator. Get random emojis by category, build fun emoji combos and reactions, and copy them with one click for chats, captions and posts.',
    category: 'Generators',
...

  {
    ...
    description:
      'Free online invoice generator. Fill in your business and client details, add line items with automatic totals and tax, preview a clean invoice and download it as a PDF.',
    category: 'PDF',
  ...
  },
  {
    ...
    description:
      'Free online purchase order generator. Enter buyer and vendor details, add ordered items with quantities and prices, and download a professional PO as a PDF.',
    category: 'PDF',
  ...
  },
  {
    ...
    description:
      'Free online certificate generator. Create award, completion and appreciation certificates with a decorative border, recipient name, title and date, and download as a PDF or PNG.',
    category: 'PDF',
  ...
  },
  {
    ...
    description:
      'Free online terms and conditions generator. Answer a few questions about your website or app and generate a customizable terms of service template you can copy or download. A starting point, not legal advice.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online privacy policy generator. Answer questions about the data your site collects and generate a customizable privacy policy template you can copy or download. A starting point, not legal advice.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online text to PDF generator. Paste or write text, choose page size, font size and margins, and download a clean multi-page PDF.',
    category: 'PDF',
...

  {
    ...
    description:
      'Free online audio tone generator. Play pure sine, square, triangle or sawtooth tones at any frequency and volume, useful for testing speakers, tinnitus matching and tuning, and download the tone as a WAV.',
    category: 'Audio & Video',
  ...
  },
  {
    ...
    description:
      'Free online waveform generator. Load an audio file and render its waveform as a clean image you can customize and download as PNG — great for podcasts, music and social posts.',
    category: 'Audio & Video',
  ...
  },
  {
    ...
    description:
      'Free online spectrogram generator. Visualize the frequency content of an audio file or your microphone over time as a color spectrogram, and download the image.',
    category: 'Audio & Video',
  ...
  },
  {
    ...
    description:
      'Free online GIF maker. Build frames from images (drag to reorder), a short video clip, or hundreds of popular templates, then add text captions and stickers with per-frame control, preview the animation, reverse or boomerang it, and export a looping GIF.',
    category: 'Image',
  ...
  },
  {
    ...
    description:
      'Free online logo generator. Pair your brand name with a symbol, font, layout and color scheme, then download a crisp SVG or PNG.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free online ambigram generator. Type one or two words and preview a rotational ambigram that reads the same when flipped 180°, then download it.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free Pictionary word generator. Draw random words for Pictionary, charades and drawing games across easy, medium and hard difficulty, with a hide-and-reveal mode for the drawer.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free random animal generator. Draw a random animal with an emoji, its group and a surprising fact — filter by mammals, birds, reptiles and more, or pull a whole list.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free random Pokémon generator. Roll one or a whole team with high-resolution official artwork, full base stats, types, abilities, height, weight and Pokédex entries. Filter by generation and type, with a shiny toggle. Uses the open PokéAPI.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free pet name generator. Generate dog, cat and small-pet name ideas by style — cute, tough, foodie, mythic or unisex — with an optional personality trait.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free gamertag generator. Create cool gaming usernames and handles for Xbox, PSN, Steam and Discord — mix adjectives, nouns, leetspeak and suffixes, with an optional keyword.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free square face generator. Mix and match eyes, mouth, eyebrows, hair and accessories, pick skin, hair and background colors, then download your square face as an SVG or PNG.',
    category: 'Image',
...

  {
    ...
    description:
      'Free email validator. Check syntax, look up live MX/DNS records to confirm the domain can receive mail, flag disposable and role-based addresses, spot typos, and validate a whole list at once.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free JSON validator. Paste JSON to check if it is valid, with the exact line and column of any syntax error plus a formatted preview.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free URL validator. Check whether a URL is well-formed and break it into protocol, host, port, path, query and fragment. Validate a single URL or a list at once.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free phone number validator. Check if a number is valid worldwide, detect the country and region, identify the line type (mobile, fixed, toll-free, VoIP), and format it as E.164, international, national and a tel: URI.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free XML validator. Paste XML to check it is well-formed, with the location of any parse error and a tidy formatted view.',
    category: 'Developer',
...

  {
    ...
    description:
      'Free XML formatter. Beautify XML with clean indentation or minify it to one line, with adjustable indent size. Well-formedness is checked as you go.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free HTML formatter. Clean up messy markup with consistent indentation or minify it for production, with a configurable indent.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free CSS formatter. Beautify stylesheets with tidy indentation and spacing, or minify them to save bytes. Adjustable indent size.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free YAML formatter. Reformat YAML with consistent indentation and flag syntax errors as you type, with adjustable indent.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free JavaScript formatter. Re-indent and clean up messy JS with consistent spacing and braces, plus a minify option.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free CSV formatter. Normalize delimiters, trim whitespace and align columns into a clean table, or convert to a chosen separator.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free Markdown formatter. Normalize headings, lists and spacing to clean Markdown and see a live rendered preview.',
    category: 'Developer',
...

  {
    ...
    description:
      'Free YAML to JSON converter. Paste YAML and get clean, formatted JSON instantly, with syntax errors flagged.',
    category: 'Converters',
  ...
  },
  {
    ...
    description:
      'Free CSV to JSON converter. Convert CSV with a header row into an array of JSON objects, with delimiter detection and pretty printing.',
    category: 'Converters',
  ...
  },
  {
    ...
    description:
      'Free JSON to CSV converter. Convert an array of JSON objects into CSV with headers, handling nested keys and a chosen delimiter.',
    category: 'Converters',
  ...
  },
  {
    ...
    description:
      'Free XML to JSON converter. Parse XML and turn elements, attributes and text into structured JSON, formatted for readability.',
    category: 'Converters',
  ...
  },
  {
    ...
    description:
      'Free Markdown to HTML converter. Paste Markdown and get the equivalent HTML plus a live preview, covering headings, lists, links, code and more.',
    category: 'Converters',
  ...
  },
  {
    ...
    description:
      'Free HTML to Markdown converter. Turn HTML markup into clean Markdown — headings, links, lists, bold, code and blockquotes.',
    category: 'Converters',
  ...
  },
  {
    ...
    description:
      'Free TOML to JSON converter. Parse TOML tables, arrays and key-value pairs into formatted JSON, with syntax errors flagged.',
    category: 'Converters',
...

  {
    ...
    description:
      'Free URL parser. Split any URL into protocol, host, port, path, query parameters and fragment, with each query key-value listed.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free user agent parser. Paste a User-Agent string to identify the browser, engine, operating system and device type, or parse your own.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free query string parser. Paste a query string or full URL to list every parameter as a decoded key-value pair, and rebuild it.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free CSV parser. Paste CSV to view it as a table and as JSON, with delimiter detection and quoted-field handling.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free log parser. Paste log output to split lines into timestamp, level and message, filter by level and search text.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free cron parser. Paste a cron expression to see a plain-English description of its schedule and the next few run times.',
    category: 'Developer',
...

  {
    ...
    description:
      'Free text analyzer. Get word, character, sentence and paragraph counts, average word and sentence length, reading time and top words for any text.',
    category: 'Text',
  ...
  },
  {
    ...
    description:
      'Free password analyzer. Measure a password’s strength, entropy in bits, character variety and estimated crack time, with tips to improve it.',
    category: 'Security',
  ...
  },
  {
    ...
    description:
      'Free color contrast analyzer. Check the WCAG contrast ratio between text and background colors and see AA/AAA pass or fail for normal and large text.',
    category: 'Image',
  ...
  },
  {
    ...
    description:
      'Free sentiment analyzer. Paste text to get a positive, neutral or negative sentiment score based on a word lexicon, with the words that drove the result.',
    category: 'Text',
  ...
  },
  {
    ...
    description:
      'Free image metadata analyzer. Drop a photo to read its dimensions, format and full metadata — EXIF camera settings, capture date, GPS location with a map link, plus IPTC and XMP. Remove all metadata and download a clean copy.',
    category: 'Image',
  ...
  },
  {
    ...
    description:
      'Free CSV analyzer and viewer. Upload a file, paste text or load a URL, then browse the data in a searchable, sortable, paged table. Profiles every column — data type, unique values, min/max/mean and empty cells — and exports to JSON, TSV or clean CSV.',
    category: 'Developer',
...

  {
    ...
    description:
      'Free palindrome checker. Test whether a word, phrase or number is a palindrome, ignoring case, spaces and punctuation, and see it reversed.',
    category: 'Text',
  ...
  },
  {
    ...
    description:
      'Free prime number checker. Enter a number to check if it is prime, see its factors if not, and find the nearest primes.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free leap year checker. Enter any year to see whether it is a leap year under the Gregorian rules, with the reasoning and the next few leap years.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free readability checker. Paste text to get Flesch Reading Ease, Flesch-Kincaid grade level and other scores, so you can gauge how easy it is to read.',
    category: 'Text',
  ...
  },
  {
    ...
    description:
      'Free Armstrong number checker. Enter a number to check if it equals the sum of its digits each raised to the number of digits, with the full working.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free perfect number checker. Enter a number to see whether it equals the sum of its proper divisors, with the divisor list and result.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free anagram checker. Enter two words or phrases to check whether they are anagrams, ignoring case, spaces and punctuation, with the sorted letters shown.',
    category: 'Text',
  ...
  },
  {
    ...
    description:
      'Free Squaredle solver and answer finder. Type any Squaredle grid (4×4 and other sizes) and instantly get every valid word, grouped by length, with the path traced on the board. Handles blocked cells and a 361,000-word dictionary.',
    category: 'Text',
...

  {
    ...
    description:
      'Free typing speed tester. Type a sample passage and get your words-per-minute, accuracy and error count in real time. No sign-up needed.',
  ...
  },
  {
    ...
    description:
      'Free reaction time tester. Wait for the color to change, then click as fast as you can to measure your reaction time in milliseconds over several rounds.',
    category: 'Device & Sensors',
  ...
  },
  {
    ...
    description:
      'Free click speed tester. Click as fast as you can within a set time to measure your clicks per second (CPS), with a live counter and your best score.',
    category: 'Device & Sensors',
  ...
  },
  {
    ...
    description:
      'Free color blindness tester. Take a quick Ishihara-style plate test and simulate protanopia, deuteranopia and tritanopia on your own images.',
    category: 'Image',
  ...
  },
  {
    ...
    description:
      'Free keyboard tester. Press keys to see them light up on an on-screen keyboard and confirm every key and modifier registers correctly.',
    category: 'Developer',
...

  {
    ...
    description:
      'Free reading time estimator. Paste text to estimate reading and speaking time at your chosen words-per-minute, with word and sentence counts.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free project cost estimator. Add tasks with hours and hourly rates to estimate total project cost, apply a contingency and see a per-task breakdown.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free calorie burn estimator. Estimate calories burned from an activity, your weight and duration using MET values across dozens of exercises.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free paint estimator. Enter room dimensions, doors and windows to estimate the wall area, paint quantity and number of coats needed.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free wallpaper estimator. Enter wall dimensions and roll size to estimate how many rolls of wallpaper you need, accounting for pattern repeat and waste.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free freelance rate estimator. Turn your target income, expenses, billable days and time off into a recommended hourly and daily rate.',
    category: 'Calculators',
...

  {
    ...
    description:
      'Free gender predictor. A just-for-fun tool that guesses baby gender from the Chinese lunar calendar using conception month and mother’s age. For entertainment only.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free love predictor. Enter two names for a just-for-fun compatibility percentage and playful message. Purely for entertainment.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free life expectancy predictor. Answer a few lifestyle questions for a rough life-expectancy estimate based on general averages. For entertainment and awareness only.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free child height predictor. Estimate a child’s likely adult height from the parents’ heights using the mid-parental method. A rough guide only.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free lucky number predictor. Enter your name and birth date for a set of just-for-fun lucky numbers derived from numerology. For entertainment only.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free career predictor. Answer a short interests quiz to get playful career suggestions that match your style. For fun and inspiration only.',
    category: 'Calculators',
...

  {
    ...
    description:
      'Free probability simulator. Run thousands of coin flips or dice rolls to watch outcomes converge on theoretical probability, with live charts.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free roulette simulator. Place bets with virtual chips and spin a European wheel to see how strategies play out over many rounds. For practice only.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free slot machine simulator: a 5-reel, 10-payline video slot with wilds, scatters, free spins, autoplay and live RTP stats. Virtual credits only, no real money.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free Monty Hall simulator. Play the three-door puzzle and run thousands of automated trials to see the win rate for staying versus switching.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free savings goal simulator. Enter a starting balance, monthly contribution and interest rate to project how long a savings goal takes to reach, with a growth chart.',
    category: 'Calculators',
...

  {
    ...
    description:
      'Free collage maker and photo editor. Choose grid or freeform layouts, set the canvas size, add text with custom fonts, stickers, shapes and doodles, and style the background with colors, gradients or a photo. Drag, resize, rotate and layer everything on an interactive canvas, save reusable templates, then export a high-resolution PNG or JPEG. Optional stock photo search uses Pexels.',
    category: 'Image',
  ...
  },
  {
    ...
    description:
      'Free word cloud maker. Paste text to generate a word cloud sized by frequency, with color and font options, then download it as a PNG.',
    category: 'Image',
  ...
  },
  {
    ...
    description:
      'Free subtitle maker. Add caption lines with start and end times to build a valid SRT subtitle file, then download it.',
    category: 'Audio & Video',
  ...
  },
  {
    ...
    description:
      'Free sprite sheet maker. Drop frames, drag to reorder, pack them into a uniform grid or a tight texture atlas, preview the animation at any FPS, then export the PNG plus a JSON atlas, CSS sprites or a ZIP bundle. You can also split an existing sheet back into frames.',
    category: 'Image',
  ...
  },
  {
    ...
    description:
      'Free sticker maker. Drop any photo — it auto-removes the background and wraps your subject in a die-cut outline. Add text, pick a shape, drop shadows, and lay out a print sheet.',
    category: 'Image',
...

  {
    ...
    description:
      'Free email signature creator. Fill in your name, title, company and links to build a clean HTML email signature, preview it live and copy the code.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free timeline maker with vertical, horizontal and alternating infographic layouts. Add point events or date ranges, auto-sort by date (even BC dates), start from ready-made templates, or auto-fill from Wikipedia history and public holidays. Import and export TimelineJS JSON, and download as PNG, SVG or PDF.',
    category: 'Image',
  ...
  },
  {
    ...
    description:
      'Free visual org chart maker. Add people with titles, photos and departments, drag boxes to change who reports to whom, switch layouts and themes, or build the whole chart from a CSV. Export PNG, SVG, PDF or a reusable JSON project.',
    category: 'Image',
...

  {
    ...
    description:
      'Free SVG downloader. Paste SVG markup to preview it, then download it as an .svg file or rasterize it to a PNG at a chosen size.',
    category: 'Image',
  ...
  },
  {
    ...
    description:
      'Free base64 file downloader. Paste a base64 string or data URI to decode it and download the resulting file, with type auto-detected.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free ICS calendar downloader. Enter an event’s title, time and location to build a valid .ics file you can import into any calendar.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free LinkedIn text formatter (Typegrow-style). Add bold, italic, underline, strikethrough and bullet lists to LinkedIn posts using Unicode that survives copy-paste.',
    category: 'Text',
  ...
  },
  {
    ...
    description:
      'Free small text generator. Convert normal text into tiny Unicode superscript, subscript and small caps that paste into Instagram, X, Discord and bios.',
    category: 'Text',
  ...
  },
  {
    ...
    description:
      'Free SQL validator. Check SQL queries for unbalanced parentheses, unterminated strings, trailing commas, misplaced clauses and other syntax problems.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free structured data validator. Check schema.org JSON-LD markup for Google rich results — extracts blocks from HTML and verifies required and recommended properties per type.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free Rust formatter. Tidy Rust source with consistent brace-based indentation and spacing. A lightweight beautifier — no account needed.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free HAR file analyzer. Summarize a HTTP Archive capture — total requests, size and time, breakdown by type and domain, and the slowest and largest requests.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free SSN validator. Check whether a US Social Security Number is structurally valid per SSA rules — area, group and serial checks plus known-invalid numbers. For form validation and test data only.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free Discord timestamp converter. Turn any date and time into Discord <t:UNIX:STYLE> markup that renders in each viewer’s timezone. All seven styles with live preview and copy.',
    category: 'Converters',
  ...
  },
  {
    ...
    description:
      'Free grams to cups converter. Convert flour, sugar, butter and more between grams, cups, tablespoons, teaspoons, ounces and millilitres using per-ingredient densities.',
    category: 'Converters',
  ...
  },
  {
    ...
    description:
      'Free eBay fee calculator. Estimate final value fees, fixed per-order fees and optional surcharges, then subtract item cost to see net profit and margin. Based on eBay US defaults.',
    category: 'Calculators',
  ...
  },
  {
    ...
    description:
      'Free Pride PFP maker. Add a Pride flag ring, overlay or corner banner to your profile picture — Rainbow, Progress, Trans, Bi, Pan, Lesbian and more.',
    category: 'Image',
  ...
  },
  {
    ...
    description:
      'Free DPI analyzer. Measure your mouse’s real DPI/CPI by dragging a set physical distance across a pad and comparing to your configured setting.',
    category: 'Developer',
  ...
  },
  {
    ...
    description:
      'Free BPM analyzer. Find any track’s tempo by tapping to the beat, or drop an audio file for automatic beat detection. Great for DJing and production.',
    category: 'Audio & Video',
  ...
  },
  {
    ...
    description:
      'Free cryptogram solver. Crack substitution-cipher puzzles with a hill-climbing auto-solver scored on English letter and trigram frequencies, or solve manually with a live substitution key.',
    category: 'Text',
  ...
  },
  {
    ...
    description:
      'Free Squardle solver. Find every valid 5-letter word from your green, yellow and gray clues, ranked by letter commonness — the same logic as Squardle and Wordle.',
    category: 'Text',
  ...
  },
  {
    ...
    description:
      'Free Kanoodle player and solver. Place, rotate and flip all 12 real pieces on the 5×11 board, then Solve, get a Hint, check if it is Solvable, or deal a Random puzzle. A backtracking exact-cover solver fills every hole.',
    category: 'Generators',
  ...
  },
  {
    ...
    description:
      'Free internet speed test with multi-stream download and upload measurement for accurate gigabit results. Measures ping, jitter, latency under load and a bufferbloat grade, detects your ISP, IP and test server, and rates your connection for calls, streaming and gaming. Tests against Cloudflare’s global edge.',
    category: 'Device & Sensors',
    keywords: [
      'internet speed test',
      'bandwidth test',
  ...
  },
  {
    ...
    description:
      'Free GPS speedometer. See your live speed, top speed, average speed, trip distance, altitude and compass heading straight from your device’s GPS, on an animated dial and large digital readout. Switch between km/h, mph, knots and m/s, set a speed-limit alert, and use HUD windshield mode with keep-awake.',
    category: 'Device & Sensors',
    keywords: [
      'gps speedometer',
      'speedometer online',
  ...
  },
  {
    ...
    description:
      'Free recipe by ingredients finder. Select the ingredients in your kitchen and instantly see recipes you can make right now, plus near-misses missing 1–2 items. Vegetarian & vegan filters.',
    category: 'Generators',
    keywords: [
