...
export const MEDIA_CONVERSIONS: MediaConversion[] = [
  {
    ...
    description: 'Free online MP4 to MP3 converter. Extract the audio track from an MP4 video and save it as an MP3 file. Choose the bitrate, trim, normalize and convert several files at once. No account.',
  ...
  },
  {
    ...
    description: 'Free online WAV to MP3 converter. Compress large uncompressed WAV audio into small, universally supported MP3 files. Pick the bitrate, adjust channels and sample rate, and batch-convert.',
  ...
  },
  {
    ...
    description: 'Free online MP3 to WAV converter. Decode MP3 audio into uncompressed WAV (PCM) for editing and mastering. Choose 16, 24 or 32-bit depth, sample rate and channels.',
  ...
  },
  {
    ...
    description: 'Free online FLAC to MP3 converter. Convert lossless FLAC audio into compact MP3 files that play on any device. Choose the bitrate, normalize loudness and convert several at once.',
  ...
  },
  {
    ...
    description: 'Free online M4A to MP3 converter. Convert M4A and AAC audio (Apple, voice memos) into universal MP3 files. Pick the bitrate, downmix to mono for voice, trim and batch-convert. No sign-up.',
  ...
  },
  {
    ...
    description: 'Free online OGG converter. Convert MP3, WAV, M4A and other audio into open OGG Vorbis format. Choose the Vorbis quality, channels and sample rate.',
  ...
  },
  {
    ...
    description: 'Free online AAC converter. Convert WAV, MP3, FLAC and other audio into efficient AAC (.m4a) files. Choose the bitrate, channels and sample rate, and convert several files at once. No account needed.',
  ...
  },
  {
    ...
    description: 'Free online MOV to MP4 converter. Convert Apple QuickTime MOV videos into widely compatible MP4 (H.264).',
  ...
  },
  {
    ...
    description: 'Free online MKV to MP4 converter. Convert Matroska MKV videos into MP4 (H.264) for broad device support.',
  ...
  },
  {
    ...
    description: 'Free online AVI to MP4 converter. Convert older AVI videos into modern MP4 (H.264) for smaller files and broad support.',
  ...
  },
  {
    ...
    description: 'Free online WMV to MP4 converter. Convert Windows Media WMV videos into MP4 (H.264) that plays on phones, Macs and the web.',
