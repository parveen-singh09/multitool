...
// .wrangler/tmp/bundle-YpKQx7/checked-fetch.js
...
// .wrangler/tmp/pages-fnZEtP/functionsWorker-0.910496916781338.mjs
...
var OFFICE_IN = /* @__PURE__ */ new Set(["doc", "docx", "odt", "rtf", "ppt", "pptx", "odp", "pps", "ppsx", "potx", "xls", "xlsx", "ods"]);
var LO_OUT = /* @__PURE__ */ new Set(["ppt", "pptx", "doc", "docx", "odp", "odt", "xls", "xlsx", "ods", "rtf"]);
var useLibreOffice = /* @__PURE__ */ __name2((from, to) => OFFICE_IN.has(from) && LO_OUT.has(to) && from !== to, "useLibreOffice");
...
var json2 = /* @__PURE__ */ __name2((body, status = 200) => new Response(JSON.stringify(body), {
  status,
...
var MAX_CHARS = 1e5;
var json3 = /* @__PURE__ */ __name2((body, status = 200) => new Response(JSON.stringify(body), {
  status,
...
// .wrangler/tmp/bundle-YpKQx7/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-YpKQx7/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.910496916781338.js.map
